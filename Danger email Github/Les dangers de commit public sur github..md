...
Dans le fonctionnement de GitHub Basic, lorsque vous n'essayez pas de comprendre vous-même ou lorsque vous n'êtes pas dans le domaine de l'osent ou même êtes victime de osent vous pouvez facilement vous demander : "Comment une personne à qui j'ai seulement donné mon GitHub a réussi à avoir mon email... 

...
Ici j'exécute entant que root pour l'option -E permet d'utiliser l'environnement actuel et pas celui du root. Je met le code source du code donc le binaire et le process id (PID) que va se rattacher GDB pour faire son mode de debuggage.

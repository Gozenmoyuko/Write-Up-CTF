...
![Write Up/img/Pasted image 20250407121510.png](Write%20Up/img/Pasted%20image%2020250407121510.png)
Ici nous voyons lorsque qu'on se connecte au ctf (SSH) que nous somme l'utilisateur **app-script-ch12@challenge02**


![Write Up/img/Pasted image 20250407121657.png](Write%20Up/img/Pasted%20image%2020250407121657.png)
...
![Write Up/img/Pasted image 20250407121814.png](Write%20Up/img/Pasted%20image%2020250407121814.png)
...
![Write Up/img/Pasted image 20250407121943.png](Write%20Up/img/Pasted%20image%2020250407121943.png)
...
Puisque le C appelle `system("ls -lA ...")`, et que **`system()` utilise `$PATH` pour chercher `ls`**, on peux créer **notre propre script `ls` malveillant** et modifier notre `PATH` pour qu’il soit appelé à la place du vrai.
 ...
 ___
 **Étape 2: 
  ![Write Up/img/Pasted image 20250407132810.png](Write%20Up/img/Pasted%20image%2020250407132810.png)
...
![Write Up/img/Pasted image 20250407134113.png](Write%20Up/img/Pasted%20image%2020250407134113.png)
...
___
![Write Up/img/Pasted image 20250407134309.png](Write%20Up/img/Pasted%20image%2020250407134309.png)
Étape 4: 
